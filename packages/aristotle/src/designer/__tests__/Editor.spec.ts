...
describe('Editor', () => {
  ...
  describe('addNode()', () => {
    ...
    it('should add a node to the canvas', () => {
      const spy = jest.spyOn(Canvas.prototype, 'add')
  ...
  describe('addConnection()', () => {
    ...
    it('should add the connection to the editor instance', () => {
      jest.spyOn(Canvas.prototype, 'add')
      editor.addConnection(source, target, index)

      expect(Canvas.prototype.add).toHaveBeenCalledWith(expect.any(Connection))
    })
  ...
  describe('setMouseMode()', () => {
    beforeEach(() => {
      jest.spyOn(Canvas.prototype, 'installEditPolicy')
    })
