(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../Circuit", "../InputNode", "../../types/Connection", "../../types/LogicValue", "../../gates/Nor"], factory);
    }
    ...
    const Nor_1 = require("../../gates/Nor");
    describe('Circuit', () => {
        let circuit;
        beforeEach(() => {
            circuit = new Circuit_1.default();
        });
        ...
        describe('addNode()', () => {
            describe('when the node is an InputNode', () => {
                let node;
                beforeEach(() => {
                    node = new InputNode_1.default('MY_INPUT');
                });
        ...
        describe('addConnection()', () => {
            ...
            let dummyNode;
            beforeEach(() => {
                sourceNode = new InputNode_1.default('MY_INPUT');
                targetNode = new Nor_1.default('NOR_1');
                dummyNode = new Nor_1.default('NOR_2');
                jest
                    .spyOn(circuit, 'next')
            ...
            it('should add a new connection entry to the source node outputs list', () => {
                ...
                expect(sourceNode.outputs[1]).toBeInstanceOf(Connection_1.default);
            ...
            it('should set the source node value to hi-Z', () => {
                circuit.addConnection(sourceNode, targetNode, 0);
                expect(sourceNode.value).toEqual(LogicValue_1.default.UNKNOWN);
            });
        ...
        describe('removeConnection()', () => {
            ...
            beforeEach(() => {
                ...
                sourceNode.outputs.push(new Connection_1.default(dummyNode, targetIndex));
                sourceNode.outputs.push(new Connection_1.default(targetNode, targetIndex));
                jest
                    .spyOn(circuit, 'next')
                    .mockImplementation(jest.fn());
            });
            it('should update the target node\'s value to hi-Z', () => {
                ...
                expect(targetNode.update).toHaveBeenCalledWith(LogicValue_1.default.UNKNOWN, targetIndex);
            });
            it('should remove the connection from the source node\'s outputs list', () => {
                expect(sourceNode.outputs[sourceIndex]).toBeInstanceOf(Connection_1.default);
        ...
        describe('removeNodeOutputs()', () => {
            ...
            it('should call `removeConnection()` for each of the node\'s outputs', () => {
                const node1 = new Nor_1.default('NOR_1');
                const node2 = new Nor_1.default('NOR_2');
                const source = new Nor_1.default('SOURCE_NODE');
                source.outputs.push(new Connection_1.default(node1, 0));
                source.outputs.push(new Connection_1.default(node2, 0));
        ...
        describe('enqueue()', () => {
            const node = new Nor_1.default('NOR_1');
        ...
        describe('next()', () => {
            ...
            let node2;
            beforeEach(() => {
                node1 = new Nor_1.default('NOR_1');
                node2 = new Nor_1.default('NOR_2');
        ...
        describe('isComplete()', () => {
            it('should return false when the queue is nonempty', () => {
                circuit.queue = [new Nor_1.default('NOR')];
