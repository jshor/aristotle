  ...
  describe('getSnappedPosition', () => {
    ...
    beforeEach(() => {
      ...
      const component = defineComponent({
        ...
        template: '<draggable data-test="draggable" />'
      })
      const parent = mount(component, {
        plugins: [
          createStore({
            getters: {
              zoom: () => 1
      ...
      const draggable = (parent.getComponent('[data-test="draggable"]') as any).vm // vue-test-utils team typed this wrong; TODO: report bug on github

      // initialize a new DragService instance
      dragService = new DragService(draggable)
      dragService.component = draggable
